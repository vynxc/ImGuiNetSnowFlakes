...
public class Renderer : Overlay
{
    ...
    protected override void Render()
    {
            ...
            ImGuiWindowFlags.NoCollapse);
        {
            ...
            ImGui.BeginChild("TabsAndContent", new Vector2(150, -1), ImGuiChildFlags.Border, ImGuiWindowFlags.None);
            {
                ComponentsHelper.VerticalTabBar([
                    ("Home", () => { Console.WriteLine("Clicked Home"); }),
                    ("Aim", () => { Console.WriteLine("Clicked Aim"); }),
                    ("Exploits", () => { Console.WriteLine("Clicked Exploits"); })
                ], ref selectedTab);
            }
            ImGui.EndChild();
        }
    ...
    private void Style()
    {
        ...
        // style.Colors[(int)ImGuiCol.ComboBg] = new Vector4(0.16f, 0.24f, 0.22f, 0.60f);
        ...
        // style.Colors[(int)ImGuiCol.Colum] = new Vector4(0.00f, 0.50f, 0.50f, 0.33f);
        // style.Colors[(int)ImGuiCol.ColumnHovered] = new Vector4(0.00f, 0.50f, 0.50f, 0.47f);
        // style.Colors[(int)ImGuiCol.ColumnActive] = new Vector4(0.00f, 0.70f, 0.70f, 1.00f);
        ...
        // style.Colors[(int)ImGuiCol.CloseButton] = new Vector4(0.00f, 0.78f, 0.78f, 0.35f);
        // style.Colors[(int)ImGuiCol.CloseButtonHovered] = new Vector4(0.00f, 0.78f, 0.78f, 0.47f);
        // style.Colors[(int)ImGuiCol.CloseButtonActive] = new Vector4(0.00f, 0.78f, 0.78f, 1.00f);
        ...
        // style.Colors[(int)ImGuiCol.TooltipBg] = new Vector4(0.00f, 0.13f, 0.13f, 0.90f);
        // style.Colors[(int)ImGuiCol.ModalWindowDarkening] = new Vector4(0.04f, 0.10f, 0.09f, 0.51f);
    }
}